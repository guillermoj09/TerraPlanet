            ...
            <div class="row"> <!-- Bloque Formulario de busqueda --> 
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                      ...
                      <form:form action="reportedescarga.html" commandName="reportePatenteFechaForm"  id="data_1" autocomplete="off">                  
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse <c:if test="${rform.collapseshow == 'SI'}"> in show</c:if>">
                                            <div class="panel-body">
                                               ...
                                               <div class="col-lg-2 b-r">
                                                        <div class="form-group">                                      
                                                              <label>Tiempo(seg) >  a </label>
                                                              <div>
                                                              
                                                                <input type="number" placeholder="10" min="0" max ='1200' id="velocidad" name ="velocidad" class="form-control" value="${rform.velocidad}" required>
								...
								<div class="table-responsive"> <!-- class="table table-striped table-bordered table-hover dataTables-example"> -->
									<table
										...
										<thead>
                                            ...
                                            <th>Patente</th>
                                            <th>N.Int</th>                                           
                                            <th>Tiempo Descarga (Seg)</th>
                                            <th>Posicion x Marca Terreno</th>                                            
                                            <!-- <th>Evento</th>  -->                                            
                                            <th>Mapa</th>                                                                                        
											</tr>
										</thead>
