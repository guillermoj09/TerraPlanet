   ...
   <!-- Contenido principal  -->
       ...
       <c:if test="${not empty mensaje}">        
	    ...
	    <c:otherwise>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                      <div class="ibox-title">
                          <h5>Filtros <b>Informe de Alarma Condición</b> &nbsp;&nbsp; &nbsp;&nbsp; <small> Buscar por ... </small></h5>                           
                      ...
                      <form:form action="reporteinformealarmacond.html" commandName="reportePatenteFechaForm"  id="data_1" autocomplete="off">                  
            ...
            </div>  <!-- Fin bloque Form de Busqueda -->   
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins  ${border}" id="ibox1">
                        ...
                        <div class="ibox-title">
                            <h5>Reporte Informe de Alarma Condición</h5>
                            <div class="ibox-tools">
                              <a class="collapse-link">
                                  <i class="fa ${link}"></i>
                              </a>
				    ...
				    <c:if test="${not  empty rlist }">	    
						...
						<c:forEach items="${rlist}" var="r" varStatus="count" >	  
		                                	...
		                                	<tr>															                                    
		                                       ...
		                                       <!-- <td title="Ver en Mapa"><font size="+1.5"><a style="color:#337ab7" class="link_mapa" link="mapaxpatentereporte.html?patente=${r.patente}"><i class="fa fa-external-link"></i></a></font></td>  -->	
    ...
    $(document).ready(function(){
        $('.dataTables-example').DataTable({
            ...
            buttons: [
                ...
                {extend: 'csv'},
                {extend: 'excel',    
                	title: 'ReporteInformeAlarmaCond',
                	 exportOptions: {
                         columns: [ 0, 1, 2, 3, 4 ,5 ]
                	 }
