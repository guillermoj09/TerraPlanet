...
/**
 * The persistent class for the turno2 database table.
 * 
 */
@Entity
@Table(name = "TURNO2", schema = "cliente")
@NamedQuery(name="Turno2.findAll", query="SELECT t FROM Turno2 t")
public class Turno2 implements Serializable {
