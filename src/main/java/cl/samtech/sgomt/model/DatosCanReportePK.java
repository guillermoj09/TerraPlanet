...
/**
 * The primary key class for the datos_can_reporte database table.
 * 
 */
@Embeddable
public class DatosCanReportePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DatosCanReportePK)) {
			return false;
		}
		DatosCanReportePK castOther = (DatosCanReportePK)other;
		return 
