...
/**
 * The persistent class for the datos_gps_ultimo database table.
 * 
 */
@Entity
@Table(name="datos_gps_ultimo")
@NamedQuery(name="DatosGpsUltimo.findAll", query="SELECT d FROM DatosGpsUltimo d")
public class DatosGpsUltimo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private DatosGpsUltimoPK id;
	...
	@Column(name="rut_geocoding")
	private String rutGeocoding;
	...
	public DatosGpsUltimo() {
	}

	public DatosGpsUltimoPK getId() {
		return this.id;
	}

	public void setId(DatosGpsUltimoPK id) {
		this.id = id;
	}
	...
	public String getRutGeocoding() {
		return this.rutGeocoding;
	}

	public void setRutGeocoding(String rutGeocoding) {
		this.rutGeocoding = rutGeocoding;
	}

    /*public Geometry getRutGeom() {
		return rutGeom;
	}

	public void setRutGeom(Geometry rutGeom) {
