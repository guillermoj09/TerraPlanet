...
/**
 * The persistent class for the datos_can_reporte_ultimo database table.
 * 
 */
@Entity
@Table(name="datos_can_reporte_ultimo")
@NamedQuery(name="DatosCanReporteUltimo.findAll", query="SELECT d FROM DatosCanReporteUltimo d")
public class DatosCanReporteUltimo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private DatosCanReporteUltimoPK id;
	...
	public DatosCanReporteUltimo() {
	}

	public DatosCanReporteUltimoPK getId() {
		return this.id;
	}

	public void setId(DatosCanReporteUltimoPK id) {
		this.id = id;
	}
