...
@Controller
public class CrearMenuHijoController {
	@RequestMapping(value = "/crearmenuhijo", method = RequestMethod.GET)
	public String showForm(Map model,HttpServletRequest request) {
		...
		return "crearmenuhijo";
	}
	
	@RequestMapping(value = "/crearmenuhijo" , method = RequestMethod.POST)
