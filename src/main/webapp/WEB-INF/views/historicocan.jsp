                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                      <div class="ibox-title">
                          <h5>Filtros <b>Historico Can</b> &nbsp;&nbsp; &nbsp;&nbsp; <small> Buscar por ... </small></h5>                           
                      ...
                      <form:form action="historicocan.html" commandName="reportePatenteFechaForm"  id="data_1" autocomplete="off">                  
                ...
                <div class="col-lg-12">
								...
								<div class="table-responsive"> <!-- class="table table-striped table-bordered table-hover dataTables-example"> -->
									<table
										...
										<thead>
                                            ...
                                            <th>N.Int</th> 
                                            <th>Odometro</th>
                                            <th>Comb. Utilizado Lt</th>                                                                                                                            
                                            <th>Nivel Comb P</th>
                                            <th>RPM</th>
                                            <th>Horometro</th>
                                            <th>Nivel Comb Lt</th>                                            
                                            <th>Torque retarder</th>
                                            <th>Crucero</th>
                                            <th>Pos Acel</th>
                                            <th>Velocidad</th>
                                           <!--  <th>Retarder</th>  -->                                                                                                                                  
				    ...
				    <c:if test="${not  empty rlist }">	    
						...
						<c:forEach items="${rlist}" var="r" varStatus="count" >	  
		                                	...
		                                	<tr>															                                    
		                                        <td><fmt:formatDate value="${r.fechaHoraGps}" pattern="dd/MM/yyyy HH:mm:ss" /> </td>		                                                                          		                                    							                                      				                                     
		                                        <td>${r.patente}</td>
		                                        <td>${r.numerointerno}</td>
		                                        <td>${r.odometro}</td>
		                                        <td>${r.horasTotMotor} </td> 		                                        
		                                         <td>${r.nivelCombP} </td>
		                                         <td>${r.rpm} </td>
		                                         <td>${r.horometro} </td>
		                                         <td>${r.nivelCombLt} </td>		                                         
		                                         <td>${r.torqueretarder} </td>
		                                         <td>${r.crucero} </td>
		                                         <td>${r.posAcel} </td>
		                                         <td>${r.spd} </td>
		                                       <!--   <td>${r.retarder} </td>  -->		                                       						                        		                                       
