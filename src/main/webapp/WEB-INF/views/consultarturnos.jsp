            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                        	...
                        	<div class="col-12 " style="padding-bottom:20px;padding-top:10px">                                                                                                              
                                       <a class="btn btn-primary" href="crearturnos">Nuevo <i class="fa fa-plus"></i></a>
			                     </div> 
				    ...
				    <c:if test="${not  empty turnos }">	    
						...
						<c:forEach items="${turnos}" var="t" varStatus="count" >	  
							                                
		                                	 <!-- <tr onClick="location.href='editarturnos?id=${c.rut}'">  --> 
		                                																  
		                                	<tr>															                                    
		                                        <td>${t.turId}</td>
		                                         <td>${t.turNombre}</td>
		                                        <td><fmt:formatDate value="${t.turDesde}" pattern="dd/MM/yyyy HH:mm:ss" /> </td>
		                                        <td><fmt:formatDate value="${t.turHasta}" pattern="dd/MM/yyyy HH:mm:ss" /> </td>
		                                        <td>${t.turTipo}</td>
		                                        <td>${t.turHoraIni}</td>
		                                        <td>${t.turHoraFin}</td>
		                                        <td>${t.turHoraIni2}</td>
		                                        <td>${t.turHoraFin2}</td>
		                                        <td>${t.usuRutUsuario}</td>
    ...
    $(document).ready(function(){
        $('.dataTables-example').DataTable({
            ...
            buttons: [
                {extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Turnos'},
                {extend: 'pdf', title: 'Turnos'},
