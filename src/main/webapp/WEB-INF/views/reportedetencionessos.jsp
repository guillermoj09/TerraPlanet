            ...
            <div class="row"> <!-- Bloque Formulario de busqueda --> 
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                      ...
                      <form:form action="reportedetencionessos.html" commandName="reportePatenteFechaForm"  id="data_1" autocomplete="off">                  
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse <c:if test="${rform.collapseshow == 'SI'}"> in show</c:if>">
                                            <div class="panel-body">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date">
                                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" id="fechaDesde" name="fechaDesde"  value="${rform.fechaDesde}" required>
                                               ...
                                               <div class="col-lg-2 b-r">
                                                        <div class="form-group">                                      
                                                              <label>Tiempo(min) >  a </label>
                                                              <div>
                                                              
                                                                <input type="number" placeholder="10" min="0" max ='800' id="velocidad" name ="velocidad" class="form-control" value="${rform.velocidad}" required>
				    ...
				    <c:if test="${not  empty rlist }">	    
						...
						<c:forEach items="${rlist}" var="r" varStatus="count" >	  
		                                	...
		                                	<tr>															                                    
		                                        <td>${r.patente}</td>
		                                        <td>${r.conductor}</td>		                                       		                                       
		                                    	<td><fmt:formatDate value="${r.fecha}" pattern="dd/MM/yyyy HH:mm" /> </td>						                                      				                                      
		                                        <td>${r.ubicacion}</td>
		                                        
		                                        <c:if test="${r.velocidad > 0}">
		                                        <td><font color="#FF0040">Fin Detencion</font></td>
		                                        </c:if>
		                                        <c:if test="${r.velocidad <= 0}">
		                                        <td><font color="#31B404">Inicio Detencion</font></td>
		                                        </c:if>
		                                          <c:if test="${not empty  r.tiempoDetenido}">
		                                        <td>${r.tiempoDetenido}</td>
		                                         </c:if>
		                                         <c:if test="${empty  r.tiempoDetenido}">
		                                         <td></td>
		                                         </c:if>
		                                         <td>${r.velocidad}</td>
