...
<body class="top-navigation">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                         ...
                         <li class="breadcrumb-item active">
                            <strong>Marcas de Terreno</strong>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Listado de Marcas de Terreno</h5>
                       
                       </div>
                                                             
                        	<div class="ibox-content">
                        	<div class="col-12 " style="padding-bottom:20px;padding-top:10px">                                                                                                              
                                       <a class="btn btn-primary" href="creamarcaterreno.html">Nueva Marca de Terreno</a>
			                     </div> 
									...
									<table
										...
										<thead>
											<tr>
		                                        ...
		                                        <th title="Vigente">Vigente</th>		                                        	                                        
		                                        <th title="Muestra en Mapa">Muestra</th>
		                                        <th title="Valido para Calculos">Calculo</th>
		                                        <th title="Icono">Icono</th>
		                                        <th title="Opciones">Opciones</th>		                                        
											</tr>
										</thead>
									 <tbody>									 
											<c:if test="${not  empty marcas }">												
												<c:forEach items="${marcas}" var="m" varStatus="count" >														                                
				                                	<tr>
				                                        <td>${m.nombre}</td>
				                                        <td>${m.descripcion}</td>
				                                        <td>${m.txt_vigencia}</td>
				                                        <td>${m.txt_muestra}</td>
				                                        <td>${m.txt_valido}</td>
				                                        <td><img src="resources/img/${m.nombre_icono}" width="16px"></td>
				                                     	<td><font size="+1.5" color="green" title="Editar" style="cursor:pointer" onClick="location.href='editamarcaterreno.html?id=${m.id_marca}'"><i class="fa fa-edit"></i></font>
				                                     		&nbsp;&nbsp;&nbsp;&nbsp;<font size="+1.5" color="red" title="Eliminar" style="cursor:pointer" ><i id ="borraMarca" name ="borraMarca" nombre="${m.nombre}" marca="${m.id_marca}" class="fa fa-trash"></i></font> </td>
				                                    </tr>
								           		</c:forEach>           
								            </c:if>	                                    	                         
		                               </tbody>
   ...
   <script src="resources/inspinia_v2.9/FullVersion/js/plugins/datapicker/bootstrap-datepicker.js"></script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#borraMarca', function(event){
        	...
        	swal({
        		title: "",
                text: "Esta seguro que desea eliminar la Marca Terreno: "+ nombre +" ?",
                type: "warning",
                ...
                swal("", "La marca ha sido eliminada.", "success");
                location.href="eliminamarcaterreno.html?id_marca="+ id_marca;
            });
